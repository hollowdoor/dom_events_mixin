...
var input1 = new MyElement('#input1');
input1.on('click', function (e){ return console.log('clicked'); });
input1.once('mousedown', function (e){ return console.log('mousedowned'); });
...
div1.on('mousemove click', function (e){
    console.log('debounced ', Date.now());
}, {debounce: 500});

var div2 = new MyElement(document);
div2.on('mousemove', '#div2',function (e){
